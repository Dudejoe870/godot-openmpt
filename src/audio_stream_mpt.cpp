...
void AudioStreamMPT::set_mix_rate(int p_hz) {
	this->mix_rate = p_hz;
}

int AudioStreamMPT::get_mix_rate() const {
	return this->mix_rate;
}
...
void AudioStreamMPT::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("set_mix_rate", "mix_rate"), &AudioStreamMPT::set_mix_rate);
	ClassDB::bind_method(D_METHOD("get_mix_rate"), &AudioStreamMPT::get_mix_rate);
